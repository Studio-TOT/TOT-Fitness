...
async function setupRailwayDatabase(client) {
    try {
        ...
        await client.query(`
            ...
            CREATE INDEX IF NOT EXISTS idx_exercise_categories_exercise_id ON exercise_categories(exercise_id);
            CREATE INDEX IF NOT EXISTS idx_exercise_categories_category_id ON exercise_categories(category_id);
            ...
            CREATE INDEX IF NOT EXISTS idx_program_days_week_id ON program_days(program_week_id);
