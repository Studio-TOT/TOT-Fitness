...
export const generateBootyPumpProgram = (exercises) => {
  ...
  program.push([
    ...getRandomExercises(
      getExercisesByMuscle(exercises, "Glutes"),
      "Barbell",
      2
    ),
    ...getRandomExercises(
  ...
  program.push([
    ...getRandomExercises(
      getExercisesByMuscle(exercises, "Quadriceps"),
      "Barbell",
      2
    ),
    ...getRandomExercises(
      getExercisesByMuscle(exercises, "Hamstrings"),
      "Dumbbells",
      2
    ),
    ...getRandomExercises(
      getExercisesByMuscle(exercises, "Calves"),
      "Bodyweight",
      1
    ),
  ]);
...
export const generateMuscleBuildingProgram = (exercises) => {
  ...
  program.push([
    ...getRandomExercises(
      getExercisesByMuscle(exercises, "Chest"),
      "Barbell",
      2
    ),
    ...getRandomExercises(
      getExercisesByMuscle(exercises, "Shoulders"),
      "Dumbbells",
      2
    ),
    ...getRandomExercises(
  ...
  program.push([
    ...getRandomExercises(
      getExercisesByMuscle(exercises, "Back"),
      "Barbell",
      2
    ),
    ...getRandomExercises(
      getExercisesByMuscle(exercises, "Biceps"),
      "Dumbbells",
      2
    ),
    ...getRandomExercises(
...
export const generateBodyweightProgram = (exercises) => {
  ...
  program.push([
    ...
    ...getRandomExercises(
      getExercisesByMuscle(exercises, "Arms"),
      "Bodyweight",
      1
    ),
  ]);
  ...
  program.push([
    ...
    ...getRandomExercises(
      getExercisesByMuscle(exercises, "Core"),
      "Bodyweight",
      1
    ),
  ]);
