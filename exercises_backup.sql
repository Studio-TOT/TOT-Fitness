...
CREATE TABLE public.categories (
    ...
    name_en_us character varying(255),
    ...
    mobile_icon character varying(255),
    description text
);
...
--
-- Name: exercise_details; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: exercise_images; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.exercise_images (
    ...
    original_video character varying(255),
    unbranded_video character varying(255),
    branded_video character varying(255)
);


--
-- Name: exercise_images_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.exercise_images_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: exercise_images_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.exercise_images_id_seq OWNED BY public.exercise_images.id;
...
--
-- Name: exercise_steps; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: exercise_steps_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.exercise_steps_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: exercise_steps_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.exercise_steps_id_seq OWNED BY public.exercise_steps.id;
...
CREATE TABLE public.exercises (
    ...
    name character varying(255) NOT NULL,
    name_en_us character varying(255),
    name_alternative character varying(255),
...
--
-- Name: forces; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: forces_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.forces_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: forces_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.forces_id_seq OWNED BY public.forces.id;
...
--
-- Name: exercise_images id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_images ALTER COLUMN id SET DEFAULT nextval('public.exercise_images_id_seq'::regclass);


--
-- Name: exercise_steps id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_steps ALTER COLUMN id SET DEFAULT nextval('public.exercise_steps_id_seq'::regclass);
...
--
-- Name: forces id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.forces ALTER COLUMN id SET DEFAULT nextval('public.forces_id_seq'::regclass);


--
-- Name: mechanics id; Type: DEFAULT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.exercise_categories
    ADD CONSTRAINT exercise_categories_pkey PRIMARY KEY (exercise_id, category_id);


--
-- Name: exercise_details exercise_details_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_details
    ADD CONSTRAINT exercise_details_pkey PRIMARY KEY (exercise_id);


--
-- Name: exercise_images exercise_images_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_images
    ADD CONSTRAINT exercise_images_pkey PRIMARY KEY (id);
...
--
-- Name: exercise_steps exercise_steps_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_steps
    ADD CONSTRAINT exercise_steps_pkey PRIMARY KEY (id);
...
--
-- Name: forces forces_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.forces
    ADD CONSTRAINT forces_pkey PRIMARY KEY (id);
...
--
-- Name: idx_exercise_categories_category_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_exercise_categories_category_id ON public.exercise_categories USING btree (category_id);


--
-- Name: idx_exercise_categories_exercise_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_exercise_categories_exercise_id ON public.exercise_categories USING btree (exercise_id);


--
-- Name: idx_exercise_images_exercise_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_exercise_images_exercise_id ON public.exercise_images USING btree (exercise_id);


--
-- Name: idx_exercise_muscles_exercise_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_exercise_muscles_exercise_id ON public.exercise_muscles USING btree (exercise_id);
...
--
-- Name: idx_exercise_steps_exercise_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_exercise_steps_exercise_id ON public.exercise_steps USING btree (exercise_id);


--
-- Name: exercise_categories exercise_categories_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_categories
    ADD CONSTRAINT exercise_categories_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(id);


--
-- Name: exercise_categories exercise_categories_exercise_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_categories
    ADD CONSTRAINT exercise_categories_exercise_id_fkey FOREIGN KEY (exercise_id) REFERENCES public.exercises(id);


--
-- Name: exercise_details exercise_details_difficulty_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_details
    ADD CONSTRAINT exercise_details_difficulty_id_fkey FOREIGN KEY (difficulty_id) REFERENCES public.difficulties(id);


--
-- Name: exercise_details exercise_details_exercise_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: exercise_details exercise_details_force_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_details
    ADD CONSTRAINT exercise_details_force_id_fkey FOREIGN KEY (force_id) REFERENCES public.forces(id);


--
-- Name: exercise_details exercise_details_mechanic_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_details
    ADD CONSTRAINT exercise_details_mechanic_id_fkey FOREIGN KEY (mechanic_id) REFERENCES public.mechanics(id);


--
-- Name: exercise_images exercise_images_exercise_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_images
    ADD CONSTRAINT exercise_images_exercise_id_fkey FOREIGN KEY (exercise_id) REFERENCES public.exercises(id);
...
--
-- Name: exercise_steps exercise_steps_exercise_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.exercise_steps
    ADD CONSTRAINT exercise_steps_exercise_id_fkey FOREIGN KEY (exercise_id) REFERENCES public.exercises(id);
